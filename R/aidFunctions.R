...
#'   by name. \cr\cr\cr **Evaluation of conditions** \cr\cr The way conditions
#'   are evaluated depends on both the type of condition and the type of
#'   function used. \cr\cr _**Class contiguity, NO.**_ When class contiguity is
...
#'   \code{\link{cond.reclass}}). \cr\cr _**Class contiguity, YES.**_ When class
...
#'   _**Absolute conditions.**_ This type of conditions applies to all functions
...
#'   \code{\link{cond.4.nofn}} and \code{\link{cond.reclass}}). \cr\cr _**Focal
#'   cell conditions.**_ This type of conditions applies only to functions
...
#'   \code{\link{anchor.seed}} and \code{\link{cond.4.nofn}}). \cr\cr _**Focal
#'   neighborhood conditions.**_ This type of conditions applies only to the
...
#'   \cr\cr _**Directional neighborhood conditions.**_ This type of conditions
