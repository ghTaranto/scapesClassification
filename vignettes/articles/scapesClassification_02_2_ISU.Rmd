...
m <-
  ...
  mapview(raster::raster(rstack[[6]]), layer.name = "Slope (deg)", col.regions = palYGB)
...
m <-
  ...
  mapview(raster::raster(rstack[[4]]), layer.name = "Regional BPI", col.regions = palBYR) + 
  mapview(raster::raster(rstack[[3]]), layer.name = "Local BPI", col.regions = palBYR)
