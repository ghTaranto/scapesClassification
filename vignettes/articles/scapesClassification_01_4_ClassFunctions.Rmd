...
* `fill_NAs = TRUE`, cell numbers extracted at the locations of a spatial vector object _and_ at all connected locations that also are incomplete cases. 
...
################################################################################
plot(rac1, col="#78b2c4", colNA= "grey", axes=FALSE, box=FALSE, legend = FALSE, asp = NA)
...
################################################################################
plot(rac2, col="#78b2c4", colNA= "grey", axes=FALSE, box=FALSE, legend = FALSE, asp = NA)
plot(pol, add = TRUE, lwd = 2.5, border = "red")
...
################################################################################
plot(rac3, col="#78b2c4", colNA= "grey", axes=FALSE, box=FALSE, legend = FALSE, asp = NA)
plot(pol, add = TRUE, lwd = 2.5, border = "red")
...
################################################################################
plot(rac4, col="#78b2c4", colNA= "grey", axes=FALSE, box=FALSE, legend = FALSE, asp = NA)
plot(pol, add = TRUE, lwd = 2.5, border = "red")
...
<div style="line-height: 0.8em; margin-bottom: 1.5em;"><span class="legend">**Figure 2 -** **Anchor.svo**, extract cell numbers at the locations of a spatial polygon (red border). Values within the plots correspond to raster cell numbers. Cells not showing a cell number are NA-cells (cells `c(9, 10, 11, 17, 18)`). **In blue**, cell numbers extracted by the function (i.e., anchor cells, _ac_).</span></div>
