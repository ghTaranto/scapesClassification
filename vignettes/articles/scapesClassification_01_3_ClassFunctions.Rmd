...
The way cell numbers are extracted depends on two function arguments: `only_NAs` and `fill_NAs` ([Figure 1](#figure1)).
...
<div style="line-height: 0.8em; margin-bottom: 1.5em;"><span class="legend">**Figure 1 - Anchor.svo** extracts cell numbers at the locations of a spatial polygon. Raster values are cell numbers. Raster cells not showing any number are NA-cells (cells `c(9, 10, 11, 17, 18)`).</span></div>
...
<div style="line-height: 0.8em; margin-bottom: 1.5em;"><span class="legend">**Figure 2 - Anchor.cell** converts a vector of cell numbers (`anchor`) into a class vector. The input vector was `1:7`. Raster values are cell numbers.</span></div>
...
<div style="line-height: 0.8em; margin-bottom: 1.5em;"><span class="legend">**Figure 3 - cond.4.all** classifies unclassified raster cells that meet function conditions. **(a)** A new class vector is computed (`cv1`). **(b)** The class vector `cv1` is updated and stored as `cv2`.</span></div>
...
<div style="line-height: 0.8em; margin-bottom: 1.5em;"><span class="legend">**Figure 4 - peak.cell** identifies local maxima and minima on a raster. **(a)** Argument `p_edge=FALSE`. (`cv1`). **(b)** Argument `p_edge=TRUE`.</span></div>
...
<div style="line-height: 0.8em; margin-bottom: 1.5em;"><span class="legend">**Figure 5 - cond.4.nofn** evaluates conditions for cells neighboring focal cells and classify them if conditions are true. An absolute neighborhood condition is evaluated with `peval = 9/9` (test cells are classified only if their value and the value of all their neighbors are `>=3`; 9 out of 9 positive evaluations). **(a)** The function do not consider class continuity. **(b)** The function consider class continuity.</span></div> 
...
<div style="line-height: 0.8em; margin-bottom: 1.5em;"><span class="legend">**Figure 6 - cond.reclass** evaluates conditions for cells of a class and reclassify them if conditions are true. **(a)** Class vector `cv2` computed by the function [cond.4.nofn](scapesClassification_01_3_ClassFunctions.html#cond-4-nofn). **(b)** cells meeting conditions are reclassified.</span></div>
